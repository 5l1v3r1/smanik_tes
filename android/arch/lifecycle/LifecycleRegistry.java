...
public class LifecycleRegistry extends Lifecycle {
  ...
  private Lifecycle.State calculateTargetState(LifecycleObserver paramLifecycleObserver) {
    ...
    if (!this.mParentStates.isEmpty())
      state = (Lifecycle.State)this.mParentStates.get(this.mParentStates.size() - 1); 
  ...
  private void popParentState() { this.mParentStates.remove(this.mParentStates.size() - 1); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/arch/lifecycle/LifecycleRegistry.class
