...
public class Barrier extends Helper {
      ...
      if (this.mAllowsGoneWidget || constraintWidget.allowedInBarrier()) {
        ...
        switch (this.mBarrierType) {
          ...
          case 3:
            ...
            break;
          case 2:
            resolutionAnchor1 = resolutionAnchor1.mTop.getResolutionNode();
            break;
          case 1:
            resolutionAnchor1 = resolutionAnchor1.mRight.getResolutionNode();
            break;
          case 0:
            resolutionAnchor1 = resolutionAnchor1.mLeft.getResolutionNode();
            break;
        } 
  ...
  public void resolve() {
    ...
    float f2;
    for (f2 = f1; i < j; f2 = f1) {
      ResolutionAnchor resolutionAnchor = (ResolutionAnchor)this.mNodes.get(i);
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/constraint/solver/widgets/Barrier.class
