...
public class ResolutionAnchor extends ResolutionNode {
  ...
  void addResolvedValue(LinearSystem paramLinearSystem) {
    ...
    if (this.resolvedTarget == null) {
      paramLinearSystem.addEquality(solverVariable, (int)this.resolvedOffset);
      return;
    } 
    paramLinearSystem.addEquality(solverVariable, paramLinearSystem.createObjectVariable(this.resolvedTarget.myAnchor), (int)this.resolvedOffset, 6);
  }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/constraint/solver/widgets/ResolutionAnchor.class
