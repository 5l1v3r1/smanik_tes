...
public class BaselineLayout extends ViewGroup {
  ...
  public BaselineLayout(Context paramContext) { super(paramContext, null, 0); }
  
  public BaselineLayout(Context paramContext, AttributeSet paramAttributeSet) { super(paramContext, paramAttributeSet, 0); }
  
  public BaselineLayout(Context paramContext, AttributeSet paramAttributeSet, int paramInt) { super(paramContext, paramAttributeSet, paramInt); }
  
  public int getBaseline() { return this.mBaseline; }
  ...
  protected void onMeasure(int paramInt1, int paramInt2) {
    ...
    while (b < i2) {
      ...
      if (view.getVisibility() != 8) {
        ...
        if (i5 != -1) {
          i3 = Math.max(k, i5);
          i4 = Math.max(j, view.getMeasuredHeight() - i5);
        } 
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/design/internal/BaselineLayout.class
