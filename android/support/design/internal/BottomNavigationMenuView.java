...
public class BottomNavigationMenuView extends ViewGroup implements MenuView {
  ...
  public BottomNavigationMenuView(Context paramContext) { this(paramContext, null); }
  ...
  public BottomNavigationMenuView(Context paramContext, AttributeSet paramAttributeSet) {
    ...
    this.mOnClickListener = new View.OnClickListener() {
        public void onClick(View param1View) {
          ...
          if (!BottomNavigationMenuView.this.mMenu.performItemAction(menuItemImpl, BottomNavigationMenuView.this.mPresenter, 0))
  ...
  @Nullable
  public ColorStateList getIconTintList() { return this.mItemIconTint; }
  
  public int getItemBackgroundRes() { return this.mItemBackgroundRes; }
  
  public ColorStateList getItemTextColor() { return this.mItemTextColor; }
  
  public int getSelectedItemId() { return this.mSelectedItemId; }
  ...
  public void setPresenter(BottomNavigationPresenter paramBottomNavigationPresenter) { this.mPresenter = paramBottomNavigationPresenter; }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/design/internal/BottomNavigationMenuView.class
