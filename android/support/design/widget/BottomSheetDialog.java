...
public class BottomSheetDialog extends AppCompatDialog {
  ...
  private View wrapInBottomSheet(int paramInt, View paramView, ViewGroup.LayoutParams paramLayoutParams) {
    ...
    this.mBehavior = BottomSheetBehavior.from(frameLayout1);
    ...
    ViewCompat.setAccessibilityDelegate(frameLayout1, new AccessibilityDelegateCompat() {
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/design/widget/BottomSheetDialog.class
