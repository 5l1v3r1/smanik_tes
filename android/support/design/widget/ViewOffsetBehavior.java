...
class ViewOffsetBehavior<V extends View> extends CoordinatorLayout.Behavior<V> {
  ...
  public ViewOffsetBehavior(Context paramContext, AttributeSet paramAttributeSet) { super(paramContext, paramAttributeSet); }
  
  public int getLeftAndRightOffset() { return (this.mViewOffsetHelper != null) ? this.mViewOffsetHelper.getLeftAndRightOffset() : 0; }
  
  public int getTopAndBottomOffset() { return (this.mViewOffsetHelper != null) ? this.mViewOffsetHelper.getTopAndBottomOffset() : 0; }
  
  protected void layoutChild(CoordinatorLayout paramCoordinatorLayout, V paramV, int paramInt) { paramCoordinatorLayout.onLayoutChild(paramV, paramInt); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/design/widget/ViewOffsetBehavior.class
