...
public class VectorDrawableCompat extends VectorDrawableCommon {
  ...
  private void printGroupTree(VGroup paramVGroup, int paramInt) {
    ...
    for (b1 = b2; b1 < paramVGroup.mChildren.size(); b1++) {
      Object object = paramVGroup.mChildren.get(b1);
      if (object instanceof VGroup) {
        printGroupTree((VGroup)object, paramInt + 1);
      } else {
        ((VPath)object).printVPath(paramInt + 1);
      } 
    } 
  }
  ...
  private void updateStateFromTypedArray(TypedArray paramTypedArray, XmlPullParser paramXmlPullParser) throws XmlPullParserException {
    ...
    vPathRenderer.setAlpha(TypedArrayUtils.getNamedFloat(paramTypedArray, stringBuilder, "alpha", 4, vPathRenderer.getAlpha()));
  ...
  public boolean isStateful() { return (this.mDelegateDrawable != null) ? this.mDelegateDrawable.isStateful() : ((super.isStateful() || (this.mVectorState != null && this.mVectorState.mTint != null && this.mVectorState.mTint.isStateful())) ? 1 : 0); }
  ...
  private static class VFullPath extends VPath {
    ...
    int getFillColor() { return this.mFillColor; }
    
    float getStrokeAlpha() { return this.mStrokeAlpha; }
    
    int getStrokeColor() { return this.mStrokeColor; }
    ...
    void setFillColor(int param1Int) { this.mFillColor = param1Int; }
    
    void setStrokeAlpha(float param1Float) { this.mStrokeAlpha = param1Float; }
    
    void setStrokeColor(int param1Int) { this.mStrokeColor = param1Int; }
  ...
  private static class VPathRenderer {
    ...
    private void drawGroupTree(VectorDrawableCompat.VGroup param1VGroup, Matrix param1Matrix, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      for (b = 0; b < param1VGroup.mChildren.size(); b++) {
        Object object = param1VGroup.mChildren.get(b);
        if (object instanceof VectorDrawableCompat.VGroup) {
          drawGroupTree((VectorDrawableCompat.VGroup)object, param1VGroup.mStackedMatrix, param1Canvas, param1Int1, param1Int2, param1ColorFilter);
        } else if (object instanceof VectorDrawableCompat.VPath) {
          drawPath(param1VGroup, (VectorDrawableCompat.VPath)object, param1Canvas, param1Int1, param1Int2, param1ColorFilter);
        } 
      } 
    ...
    private void drawPath(VectorDrawableCompat.VGroup param1VGroup, VectorDrawableCompat.VPath param1VPath, Canvas param1Canvas, int param1Int1, int param1Int2, ColorFilter param1ColorFilter) {
      ...
      if (param1VPath.mFillColor != 0) {
        ...
        paint.setColor(VectorDrawableCompat.applyAlpha(param1VPath.mFillColor, param1VPath.mFillAlpha));
      ...
      if (param1VPath.mStrokeColor != 0) {
        ...
        paint.setColor(VectorDrawableCompat.applyAlpha(param1VPath.mStrokeColor, param1VPath.mStrokeAlpha));
        paint.setColorFilter(param1ColorFilter);
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/graphics/drawable/VectorDrawableCompat.class
