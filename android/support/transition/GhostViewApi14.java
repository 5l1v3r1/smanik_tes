...
class GhostViewApi14 extends View implements GhostViewImpl {
  ...
  static GhostViewApi14 getGhostView(@NonNull View paramView) { return (GhostViewApi14)paramView.getTag(R.id.ghost_view); }
  
  private static void setGhostView(@NonNull View paramView, GhostViewApi14 paramGhostViewApi14) { paramView.setTag(R.id.ghost_view, paramGhostViewApi14); }
  ...
  static class Creator implements GhostViewImpl.Creator {
    ...
    public void removeGhost(View param1View) {
      ...
      if (param1View != null) {
        param1View.mReferences--;
        if (param1View.mReferences <= 0) {
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/transition/GhostViewApi14.class
