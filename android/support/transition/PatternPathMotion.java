...
public class PatternPathMotion extends PathMotion {
  ...
  public PatternPathMotion(Context paramContext, AttributeSet paramAttributeSet) {
    typedArray = paramContext.obtainStyledAttributes(paramAttributeSet, Styleable.PATTERN_PATH_MOTION);
    try {
  ...
  public PatternPathMotion(Path paramPath) { setPatternPath(paramPath); }
  
  private static float distance(float paramFloat1, float paramFloat2) { return (float)Math.sqrt((paramFloat1 * paramFloat1 + paramFloat2 * paramFloat2)); }
  ...
  public Path getPatternPath() { return this.mOriginalPatternPath; }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/transition/PatternPathMotion.class
