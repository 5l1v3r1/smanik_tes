...
public class Slide extends Visibility {
  ...
  static  {
    ...
    sCalculateLeft = new CalculateSlideHorizontal() {
        public float getGoneX(ViewGroup param1ViewGroup, View param1View) { return param1View.getTranslationX() - param1ViewGroup.getWidth(); }
      };
    sCalculateStart = new CalculateSlideHorizontal() {
        public float getGoneX(ViewGroup param1ViewGroup, View param1View) {
          int i = ViewCompat.getLayoutDirection(param1ViewGroup);
          boolean bool = true;
          if (i != 1)
            bool = false; 
    ...
    sCalculateTop = new CalculateSlideVertical() {
        public float getGoneY(ViewGroup param1ViewGroup, View param1View) { return param1View.getTranslationY() - param1ViewGroup.getHeight(); }
      };
  ...
  private static abstract class CalculateSlideHorizontal implements CalculateSlide {
    ...
    public float getGoneY(ViewGroup param1ViewGroup, View param1View) { return param1View.getTranslationY(); }
  }
  
  private static abstract class CalculateSlideVertical implements CalculateSlide {
    private CalculateSlideVertical() {}
    
    public float getGoneX(ViewGroup param1ViewGroup, View param1View) { return param1View.getTranslationX(); }
  }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/transition/Slide.class
