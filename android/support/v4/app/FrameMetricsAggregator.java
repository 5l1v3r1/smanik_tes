...
public class FrameMetricsAggregator {
  ...
  private static class FrameMetricsApi24Impl extends FrameMetricsBaseImpl {
    ...
    public void add(Activity param1Activity) {
      ...
      for (byte b = 0; b <= 8; b++) {
        if (this.mMetrics[b] == null && (this.mTrackingFlags & true << b) != 0)
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/app/FrameMetricsAggregator.class
