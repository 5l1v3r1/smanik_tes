...
class LoaderManagerImpl extends LoaderManager {
  ...
  private <D> Loader<D> createAndInstallLoader(int paramInt, @Nullable Bundle paramBundle, @NonNull LoaderManager.LoaderCallbacks<D> paramLoaderCallbacks, @Nullable Loader<D> paramLoader) {
    try {
      ...
      loaderInfo = new LoaderInfo(paramInt, stringBuilder, loader, paramLoader);
      if (DEBUG) {
  ...
  void markForRedelivery() { this.mLoaderViewModel.markForRedelivery(); }
  ...
  public static class LoaderInfo<D> extends MutableLiveData<D> implements Loader.OnLoadCompleteListener<D> {
    ...
    public void removeObserver(@NonNull Observer<D> param1Observer) {
    ...
    Loader<D> setCallback(@NonNull LifecycleOwner param1LifecycleOwner, @NonNull LoaderManager.LoaderCallbacks<D> param1LoaderCallbacks) {
      LoaderManagerImpl.LoaderObserver loaderObserver = new LoaderManagerImpl.LoaderObserver(this.mLoader, param1LoaderCallbacks);
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/app/LoaderManagerImpl.class
