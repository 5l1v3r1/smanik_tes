...
public final class ShareCompat {
  ...
  public static void configureMenuItem(Menu paramMenu, int paramInt, IntentBuilder paramIntentBuilder) {
    StringBuilder stringBuilder = paramMenu.findItem(paramInt);
    ...
    configureMenuItem(stringBuilder, paramIntentBuilder);
  }
  ...
  public static class IntentReader {
    ...
    public Uri getStream(int param1Int) {
      ...
      if (this.mStreams != null)
        return (Uri)this.mStreams.get(param1Int); 
      if (param1Int == 0)
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/app/ShareCompat.class
