...
public final class ColorUtils {
  ...
  public static int calculateMinimumAlpha(@ColorInt int paramInt1, @ColorInt int paramInt2, float paramFloat) {
    ...
    while (i <= 10 && c1 - c2 > '\001') {
      char c = (c2 + c1) / '\002';
      if (calculateContrast(setAlphaComponent(paramInt1, c), paramInt2) < d2) {
        c2 = c;
      } else {
        c1 = c;
      } 
  ...
  private static double pivotXyzComponent(double paramDouble) { return (paramDouble > 0.008856D) ? Math.pow(paramDouble, 0.3333333333333333D) : ((paramDouble * 903.3D + 16.0D) / 116.0D); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/graphics/ColorUtils.class
