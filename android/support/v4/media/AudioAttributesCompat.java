...
public class AudioAttributesCompat {
    ...
    if (paramObject != null) {
      ...
      if (this.mContentType == paramObject.getContentType() && this.mFlags == paramObject.getFlags() && this.mUsage == paramObject.getUsage())
        if (this.mLegacyStream != null) {
          if (this.mLegacyStream.equals(paramObject.mLegacyStream))
            return true; 
        } else if (paramObject.mLegacyStream == null) {
          return true;
        }  
      return false;
    } 
  ...
  public int getContentType() { return (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap().getContentType() : this.mContentType; }
  ...
  public int getLegacyStreamType() { return (this.mLegacyStream != null) ? this.mLegacyStream.intValue() : ((Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior) ? AudioAttributesCompatApi21.toLegacyStreamType(this.mAudioAttributesWrapper) : toVolumeStreamType(false, this.mFlags, this.mUsage)); }
  
  public int getUsage() { return (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap().getUsage() : this.mUsage; }
  ...
  public int hashCode() { return (Build.VERSION.SDK_INT >= 21 && !sForceLegacyBehavior && this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap().hashCode() : Arrays.hashCode(new Object[] { Integer.valueOf(this.mContentType), Integer.valueOf(this.mFlags), Integer.valueOf(this.mUsage), this.mLegacyStream }); }
  ...
  @Nullable
  public Object unwrap() { return (this.mAudioAttributesWrapper != null) ? this.mAudioAttributesWrapper.unwrap() : null; }
  
  String usageToString() { return usageToString(this.mUsage); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/AudioAttributesCompat.class
