...
public final class MediaBrowserCompat {
  ...
  private static class CallbackHandler extends Handler {
    ...
    CallbackHandler(MediaBrowserCompat.MediaBrowserServiceCallbackImpl param1MediaBrowserServiceCallbackImpl) { this.mCallbackImplRef = new WeakReference(param1MediaBrowserServiceCallbackImpl); }
    ...
    public void handleMessage(Message param1Message) {
      if (this.mCallbacksMessengerRef != null && this.mCallbacksMessengerRef.get() != null) {
        ...
        MediaBrowserCompat.MediaBrowserServiceCallbackImpl mediaBrowserServiceCallbackImpl = (MediaBrowserCompat.MediaBrowserServiceCallbackImpl)this.mCallbackImplRef.get();
        ...
        try {
          ...
          return;
        } catch (BadParcelableException bundle) {
    ...
    void setCallbacksMessenger(Messenger param1Messenger) { this.mCallbacksMessengerRef = new WeakReference(param1Messenger); }
  }
  ...
  public static class ConnectionCallback {
    ...
    void setInternalConnectionCallback(ConnectionCallbackInternal param1ConnectionCallbackInternal) { this.mConnectionCallbackInternal = param1ConnectionCallbackInternal; }
  ...
  public static abstract class ItemCallback {
    ...
    private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
      public void onError(@NonNull String param2String) { MediaBrowserCompat.ItemCallback.this.onError(param2String); }
  ...
  private class StubApi23 implements MediaBrowserCompatApi23.ItemCallback {
    ...
    public void onError(@NonNull String param1String) { this.this$0.onError(param1String); }
  ...
  static class MediaBrowserImplApi21 implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl, ConnectionCallback.ConnectionCallbackInternal {
    ...
    public void connect() { MediaBrowserCompatApi21.connect(this.mBrowserObj); }
    ...
    @Nullable
    public Bundle getExtras() { return MediaBrowserCompatApi21.getExtras(this.mBrowserObj); }
    ...
    public void getItem(@NonNull final String mediaId, @NonNull final MediaBrowserCompat.ItemCallback cb) {
      ...
      if (!MediaBrowserCompatApi21.isConnected(this.mBrowserObj)) {
        ...
        this.mHandler.post(new Runnable() {
              public void run() { cb.onError(mediaId); }
            });
        return;
      } 
      ...
      itemReceiver = new MediaBrowserCompat.ItemReceiver(param1String, param1ItemCallback, this.mHandler);
      try {
        this.mServiceBinderWrapper.getMediaItem(param1String, itemReceiver, this.mCallbacksMessenger);
        return;
      } catch (RemoteException itemReceiver) {
        StringBuilder stringBuilder = new StringBuilder();
    ...
    @NonNull
    public String getRoot() { return MediaBrowserCompatApi21.getRoot(this.mBrowserObj); }
    
    public ComponentName getServiceComponent() { return MediaBrowserCompatApi21.getServiceComponent(this.mBrowserObj); }
    ...
    public boolean isConnected() { return MediaBrowserCompatApi21.isConnected(this.mBrowserObj); }
    ...
    public void onConnected() {
      ...
      iBinder = BundleCompat.getBinder(bundle, "extra_messenger");
      if (iBinder != null) {
    ...
    public void onLoadChildren(Messenger param1Messenger, String param1String, List param1List, Bundle param1Bundle) {
      if (this.mCallbacksMessenger != param1Messenger)
        return; 
      StringBuilder stringBuilder = (MediaBrowserCompat.Subscription)this.mSubscriptions.get(param1String);
    ...
    public void search(@NonNull final String query, final Bundle extras, @NonNull final MediaBrowserCompat.SearchCallback callback) {
      ...
      if (this.mServiceBinderWrapper == null) {
        ...
        this.mHandler.post(new Runnable() {
              public void run() { callback.onError(query, extras); }
            });
        return;
      } 
      searchResultReceiver = new MediaBrowserCompat.SearchResultReceiver(param1String, param1Bundle, param1SearchCallback, this.mHandler);
      try {
        this.mServiceBinderWrapper.search(param1String, param1Bundle, searchResultReceiver, this.mCallbacksMessenger);
        return;
      } catch (RemoteException searchResultReceiver) {
        StringBuilder stringBuilder = new StringBuilder();
        stringBuilder.append("Remote error searching items with query: ");
        stringBuilder.append(param1String);
        Log.i("MediaBrowserCompat", stringBuilder.toString(), searchResultReceiver);
        this.mHandler.post(new Runnable() {
              public void run() { callback.onError(query, extras); }
            });
        return;
    ...
    public void sendCustomAction(@NonNull final String action, final Bundle extras, @Nullable MediaBrowserCompat.CustomActionCallback param1CustomActionCallback) {
      ...
      if (this.mServiceBinderWrapper == null) {
        ...
        if (stringBuilder != null)
          this.mHandler.post(new Runnable() {
                public void run() { callback.onError(action, extras, null); }
              }); 
      } 
      customActionResultReceiver = new MediaBrowserCompat.CustomActionResultReceiver(param1String, param1Bundle, stringBuilder, this.mHandler);
      try {
        this.mServiceBinderWrapper.sendCustomAction(param1String, param1Bundle, customActionResultReceiver, this.mCallbacksMessenger);
        return;
      } catch (RemoteException customActionResultReceiver) {
        ...
        Log.i("MediaBrowserCompat", stringBuilder1.toString(), customActionResultReceiver);
        if (stringBuilder != null)
          this.mHandler.post(new Runnable() {
                public void run() { callback.onError(action, extras, null); }
              }); 
    ...
    public void subscribe(@NonNull String param1String, Bundle param1Bundle, @NonNull MediaBrowserCompat.SubscriptionCallback param1SubscriptionCallback) {
      ...
      subscription1.putCallback(this.mContext, param1Bundle, param1SubscriptionCallback);
      if (this.mServiceBinderWrapper == null) {
    ...
    public void unsubscribe(@NonNull String param1String, MediaBrowserCompat.SubscriptionCallback param1SubscriptionCallback) {
      ...
      if (this.mServiceBinderWrapper == null) {
        if (param1SubscriptionCallback == null) {
          ...
          List list1 = subscription.getCallbacks();
  ...
  static class MediaBrowserImplApi23 extends MediaBrowserImplApi21 {
    MediaBrowserImplApi23(Context param1Context, ComponentName param1ComponentName, MediaBrowserCompat.ConnectionCallback param1ConnectionCallback, Bundle param1Bundle) { super(param1Context, param1ComponentName, param1ConnectionCallback, param1Bundle); }
  ...
  static class MediaBrowserImplApi26 extends MediaBrowserImplApi23 {
    MediaBrowserImplApi26(Context param1Context, ComponentName param1ComponentName, MediaBrowserCompat.ConnectionCallback param1ConnectionCallback, Bundle param1Bundle) { super(param1Context, param1ComponentName, param1ConnectionCallback, param1Bundle); }
  ...
  static class MediaBrowserImplBase implements MediaBrowserImpl, MediaBrowserServiceCallbackImpl {
    ...
    public boolean isConnected() { return (this.mState == 3); }
    ...
    public void onLoadChildren(Messenger param1Messenger, String param1String, List param1List, Bundle param1Bundle) {
      ...
      if (MediaBrowserCompat.DEBUG) {
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("onLoadChildren for ");
      ...
      try {
        for (Map.Entry entry : this.mSubscriptions.entrySet()) {
          ...
          for (b = 0; b < list1.size(); b++)
            this.mServiceBinderWrapper.addSubscription(param1String, ((MediaBrowserCompat.SubscriptionCallback)list1.get(b)).mToken, (Bundle)list2.get(b), this.mCallbacksMessenger); 
        } 
      } catch (RemoteException param1Messenger) {
    ...
    public void search(@NonNull String param1String, final Bundle extras, @NonNull final MediaBrowserCompat.SearchCallback callback) {
      ...
      searchResultReceiver = new MediaBrowserCompat.SearchResultReceiver(stringBuilder, param1Bundle, param1SearchCallback, this.mHandler);
      try {
        this.mServiceBinderWrapper.search(stringBuilder, param1Bundle, searchResultReceiver, this.mCallbacksMessenger);
        return;
      } catch (RemoteException searchResultReceiver) {
        StringBuilder stringBuilder1 = new StringBuilder();
        stringBuilder1.append("Remote error searching items with query: ");
        stringBuilder1.append(stringBuilder);
        Log.i("MediaBrowserCompat", stringBuilder1.toString(), searchResultReceiver);
        this.mHandler.post(new Runnable() {
              public void run() { callback.onError(query, extras); }
            });
        return;
    ...
    private class MediaServiceConnection implements ServiceConnection {
      ...
      public void onServiceConnected(final ComponentName name, final IBinder binder) { postOrRun(new Runnable() {
              public void run() {
                if (MediaBrowserCompat.DEBUG) {
                  StringBuilder stringBuilder = new StringBuilder();
      ...
      public void onServiceDisconnected(final ComponentName name) { postOrRun(new Runnable() {
              public void run() {
                if (MediaBrowserCompat.DEBUG) {
                  StringBuilder stringBuilder = new StringBuilder();
  ...
  public static class MediaItem implements Parcelable {
    public static final Parcelable.Creator<MediaItem> CREATOR = new Parcelable.Creator<MediaItem>() {
        public MediaBrowserCompat.MediaItem createFromParcel(Parcel param2Parcel) { return new MediaBrowserCompat.MediaItem(param2Parcel); }
        
        public MediaBrowserCompat.MediaItem[] newArray(int param2Int) { return new MediaBrowserCompat.MediaItem[param2Int]; }
      };
    ...
    public int getFlags() { return this.mFlags; }
    
    @Nullable
    public String getMediaId() { return this.mDescription.getMediaId(); }
    
    public boolean isBrowsable() { return ((this.mFlags & true) != 0); }
    
    public boolean isPlayable() { return ((this.mFlags & 0x2) != 0); }
  ...
  static final class null extends Object implements Parcelable.Creator<MediaItem> {
    public MediaBrowserCompat.MediaItem createFromParcel(Parcel param1Parcel) { return new MediaBrowserCompat.MediaItem(param1Parcel); }
    
    public MediaBrowserCompat.MediaItem[] newArray(int param1Int) { return new MediaBrowserCompat.MediaItem[param1Int]; }
  }
  ...
  private static class ServiceBinderWrapper {
    ...
    void disconnect(Messenger param1Messenger) { sendRequest(2, null, param1Messenger); }
    ...
    void getMediaItem(String param1String, ResultReceiver param1ResultReceiver, Messenger param1Messenger) throws RemoteException {
      Bundle bundle = new Bundle();
      bundle.putString("data_media_item_id", param1String);
      bundle.putParcelable("data_result_receiver", param1ResultReceiver);
    ...
    void unregisterCallbackMessenger(Messenger param1Messenger) { sendRequest(7, null, param1Messenger); }
  }
  ...
  private static class Subscription {
    ...
    public MediaBrowserCompat.SubscriptionCallback getCallback(Context param1Context, Bundle param1Bundle) {
      ...
      for (byte b = 0; b < this.mOptionsList.size(); b++) {
        if (MediaBrowserCompatUtils.areSameOptions((Bundle)this.mOptionsList.get(b), param1Bundle))
          return (MediaBrowserCompat.SubscriptionCallback)this.mCallbacks.get(b); 
      } 
      return null;
    }
    
    public List<MediaBrowserCompat.SubscriptionCallback> getCallbacks() { return this.mCallbacks; }
    
    public List<Bundle> getOptionsList() { return this.mOptionsList; }
    
    public boolean isEmpty() { return this.mCallbacks.isEmpty(); }
    ...
    public void putCallback(Context param1Context, Bundle param1Bundle, MediaBrowserCompat.SubscriptionCallback param1SubscriptionCallback) {
      if (param1Bundle != null)
        param1Bundle.setClassLoader(param1Context.getClassLoader()); 
      byte b;
      for (b = 0; b < this.mOptionsList.size(); b++) {
        if (MediaBrowserCompatUtils.areSameOptions((Bundle)this.mOptionsList.get(b), param1Bundle)) {
  ...
  public static abstract class SubscriptionCallback {
    ...
    private void setSubscription(MediaBrowserCompat.Subscription param1Subscription) { this.mSubscriptionRef = new WeakReference(param1Subscription); }
    ...
    private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
      List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> param2List, Bundle param2Bundle) {
        ...
        int m = param2Bundle.getInt("android.media.browse.extra.PAGE_SIZE", -1);
        if (i == -1 && m == -1)
          return param2List; 
        int k = m * i;
        int j = k + m;
      ...
      public void onChildrenLoaded(@NonNull String param2String, List<?> param2List) {
        ...
        if (MediaBrowserCompat.SubscriptionCallback.this.mSubscriptionRef == null) {
          ...
          subscription = (MediaBrowserCompat.Subscription)MediaBrowserCompat.SubscriptionCallback.this.mSubscriptionRef.get();
        } 
        if (subscription == null) {
        ...
        List list2 = subscription.getCallbacks();
        List list1 = subscription.getOptionsList();
        for (byte b = 0; b < list2.size(); b++) {
          Bundle bundle = (Bundle)list1.get(b);
          if (bundle == null) {
            MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(param2String, param2List);
          } else {
            MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(param2String, applyOptions(param2List, bundle), bundle);
          } 
        } 
      }
      
      public void onError(@NonNull String param2String) { MediaBrowserCompat.SubscriptionCallback.this.onError(param2String); }
    }
    
    private class StubApi26 extends StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
      StubApi26() { super(MediaBrowserCompat.SubscriptionCallback.this); }
      
      public void onChildrenLoaded(@NonNull String param2String, List<?> param2List, @NonNull Bundle param2Bundle) { MediaBrowserCompat.SubscriptionCallback.this.onChildrenLoaded(param2String, MediaBrowserCompat.MediaItem.fromMediaItemList(param2List), param2Bundle); }
      
      public void onError(@NonNull String param2String, @NonNull Bundle param2Bundle) { MediaBrowserCompat.SubscriptionCallback.this.onError(param2String, param2Bundle); }
    }
  }
  ...
  private class StubApi21 implements MediaBrowserCompatApi21.SubscriptionCallback {
    ...
    List<MediaBrowserCompat.MediaItem> applyOptions(List<MediaBrowserCompat.MediaItem> param1List, Bundle param1Bundle) {
      ...
      int m = param1Bundle.getInt("android.media.browse.extra.PAGE_SIZE", -1);
      if (i == -1 && m == -1)
        return param1List; 
      int k = m * i;
      int j = k + m;
    ...
    public void onChildrenLoaded(@NonNull String param1String, List<?> param1List) {
      ...
      if (this.this$0.mSubscriptionRef == null) {
        ...
        subscription = (MediaBrowserCompat.Subscription)this.this$0.mSubscriptionRef.get();
      } 
      if (subscription == null) {
      ...
      for (byte b = 0; b < list2.size(); b++) {
        Bundle bundle = (Bundle)list1.get(b);
        if (bundle == null) {
          this.this$0.onChildrenLoaded(param1String, param1List);
        } else {
          this.this$0.onChildrenLoaded(param1String, applyOptions(param1List, bundle), bundle);
        } 
      } 
    }
  ...
  private class StubApi26 extends SubscriptionCallback.StubApi21 implements MediaBrowserCompatApi26.SubscriptionCallback {
    StubApi26() { super(MediaBrowserCompat.this); }
    
    public void onChildrenLoaded(@NonNull String param1String, List<?> param1List, @NonNull Bundle param1Bundle) { this.this$0.onChildrenLoaded(param1String, MediaBrowserCompat.MediaItem.fromMediaItemList(param1List), param1Bundle); }
    
    public void onError(@NonNull String param1String, @NonNull Bundle param1Bundle) { this.this$0.onError(param1String, param1Bundle); }
  }
}


/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/MediaBrowserCompat.class
