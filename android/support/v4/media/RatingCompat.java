...
public final class RatingCompat implements Parcelable {
  public static final Parcelable.Creator<RatingCompat> CREATOR = new Parcelable.Creator<RatingCompat>() {
      public RatingCompat createFromParcel(Parcel param1Parcel) { return new RatingCompat(param1Parcel.readInt(), param1Parcel.readFloat()); }
      
      public RatingCompat[] newArray(int param1Int) { return new RatingCompat[param1Int]; }
    };
  ...
  public static RatingCompat fromRating(Object paramObject) {
    if (paramObject != null && Build.VERSION.SDK_INT >= 19) {
      RatingCompat ratingCompat = (Rating)paramObject;
      int i = ratingCompat.getRatingStyle();
      if (ratingCompat.isRated()) {
        switch (i) {
          default:
            return null;
          case 6:
            ratingCompat1 = newPercentageRating(ratingCompat.getPercentRating());
            ratingCompat1.mRatingObj = paramObject;
            return ratingCompat1;
          case 3:
          case 4:
          case 5:
            ratingCompat1 = newStarRating(i, ratingCompat1.getStarRating());
            ratingCompat1.mRatingObj = paramObject;
            return ratingCompat1;
          case 2:
            ratingCompat1 = newThumbRating(ratingCompat1.isThumbUp());
            ratingCompat1.mRatingObj = paramObject;
            return ratingCompat1;
          case 1:
            break;
        } 
        RatingCompat ratingCompat1 = newHeartRating(ratingCompat1.hasHeart());
      } else {
  ...
  public int describeContents() { return this.mRatingStyle; }
  
  public float getPercentRating() { return (this.mRatingStyle != 6 || !isRated()) ? -1.0F : this.mRatingValue; }
  ...
  public int getRatingStyle() { return this.mRatingStyle; }
  ...
  public boolean isRated() { return (this.mRatingValue >= 0.0F); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/RatingCompat.class
