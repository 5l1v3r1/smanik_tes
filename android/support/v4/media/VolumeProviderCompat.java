...
public abstract class VolumeProviderCompat {
  ...
  public final int getCurrentVolume() { return this.mCurrentVolume; }
  
  public final int getMaxVolume() { return this.mMaxVolume; }
  
  public final int getVolumeControl() { return this.mControlType; }
  ...
  public Object getVolumeProvider() {
    if (this.mVolumeProviderObj == null && Build.VERSION.SDK_INT >= 21)
      this.mVolumeProviderObj = VolumeProviderCompatApi21.createVolumeProvider(this.mControlType, this.mMaxVolume, this.mCurrentVolume, new VolumeProviderCompatApi21.Delegate() {
            public void onAdjustVolume(int param1Int) { VolumeProviderCompat.this.onAdjustVolume(param1Int); }
            
            public void onSetVolumeTo(int param1Int) { VolumeProviderCompat.this.onSetVolumeTo(param1Int); }
          }); 
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/VolumeProviderCompat.class
