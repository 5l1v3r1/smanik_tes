...
public class MediaButtonReceiver extends BroadcastReceiver {
  ...
  private static class MediaButtonConnectionCallback extends MediaBrowserCompat.ConnectionCallback {
    ...
    public void onConnectionFailed() { finish(); }
    
    public void onConnectionSuspended() { finish(); }
    
    void setMediaBrowser(MediaBrowserCompat param1MediaBrowserCompat) { this.mMediaBrowser = param1MediaBrowserCompat; }
  }
}


/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/session/MediaButtonReceiver.class
