...
public final class MediaControllerCompat {
  ...
  public static abstract class Callback implements IBinder.DeathRecipient {
    ...
    public void binderDied() { onSessionDestroyed(); }
    ...
    private class MessageHandler extends Handler {
      ...
      MessageHandler(Looper param2Looper) { super(param2Looper); }
      ...
      public void handleMessage(Message param2Message) {
        ...
        switch (param2Message.what) {
          ...
          case 6:
            ...
            return;
          case 5:
            MediaControllerCompat.Callback.this.onQueueChanged((List)param2Message.obj);
            return;
          case 4:
    ...
    private static class StubApi21 implements MediaControllerCompatApi21.Callback {
      ...
      StubApi21(MediaControllerCompat.Callback param2Callback) { this.mCallback = new WeakReference(param2Callback); }
    ...
    private static class StubCompat extends IMediaControllerCallback.Stub {
      ...
      StubCompat(MediaControllerCompat.Callback param2Callback) { this.mCallback = new WeakReference(param2Callback); }
      
      public void onCaptioningEnabledChanged(boolean param2Boolean) {
        MediaControllerCompat.Callback callback = (MediaControllerCompat.Callback)this.mCallback.get();
        if (callback != null)
      ...
      public void onShuffleModeChanged(int param2Int) {
        MediaControllerCompat.Callback callback = (MediaControllerCompat.Callback)this.mCallback.get();
        if (callback != null)
          callback.postToHandler(12, Integer.valueOf(param2Int), null); 
      }
      
      public void onShuffleModeChangedRemoved(boolean param2Boolean) {}
  ...
  private class MessageHandler extends Handler {
    ...
    MessageHandler(Looper param1Looper) { super(param1Looper); }
    ...
    public void handleMessage(Message param1Message) {
      ...
      switch (param1Message.what) {
        ...
        case 6:
          ...
          return;
        case 5:
          this.this$0.onQueueChanged((List)param1Message.obj);
          return;
        case 4:
  ...
  private static class StubApi21 implements MediaControllerCompatApi21.Callback {
    ...
    StubApi21(MediaControllerCompat.Callback param1Callback) { this.mCallback = new WeakReference(param1Callback); }
  ...
  private static class StubCompat extends IMediaControllerCallback.Stub {
    ...
    StubCompat(MediaControllerCompat.Callback param1Callback) { this.mCallback = new WeakReference(param1Callback); }
    ...
    public void onShuffleModeChangedRemoved(boolean param1Boolean) {}
  ...
  private static class MediaControllerExtraData extends SupportActivity.ExtraData {
    ...
    MediaControllerExtraData(MediaControllerCompat param1MediaControllerCompat) { this.mMediaController = param1MediaControllerCompat; }
    
    MediaControllerCompat getMediaController() { return this.mMediaController; }
  }
  ...
  static class MediaControllerImplApi21 implements MediaControllerImpl {
    ...
    public MediaControllerImplApi21(Context param1Context, MediaSessionCompat.Token param1Token) throws RemoteException {
      ...
      this.mExtraBinder = param1Token.getExtraBinder();
    ...
    public MediaControllerImplApi21(Context param1Context, MediaSessionCompat param1MediaSessionCompat) {
      ...
      this.mExtraBinder = param1MediaSessionCompat.getSessionToken().getExtraBinder();
      if (this.mExtraBinder == null)
        requestExtraBinder(); 
    }
    ...
    private void processPendingCallbacks() {
      ...
      synchronized (this.mPendingCallbacks) {
        iterator = this.mPendingCallbacks.iterator();
        while (true) {
          if (iterator.hasNext()) {
            ...
            try {
              ...
              continue;
            } catch (RemoteException iterator) {
              Log.e("MediaControllerCompat", "Dead object in registerCallback.", iterator);
            } 
          } else {
            break;
          } 
    ...
    private void requestExtraBinder() { sendCommand("android.support.v4.media.session.command.GET_EXTRA_BINDER", null, new ExtraBinderRequestResultReceiver(this, new Handler())); }
    
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      if ((getFlags() & 0x4L) == 0L)
        throw new UnsupportedOperationException("This session doesn't support queue management operations"); 
      Bundle bundle = new Bundle();
      bundle.putParcelable("android.support.v4.media.session.command.ARGUMENT_MEDIA_DESCRIPTION", param1MediaDescriptionCompat);
    ...
    public void adjustVolume(int param1Int1, int param1Int2) { MediaControllerCompatApi21.adjustVolume(this.mControllerObj, param1Int1, param1Int2); }
    
    public boolean dispatchMediaButtonEvent(KeyEvent param1KeyEvent) { return MediaControllerCompatApi21.dispatchMediaButtonEvent(this.mControllerObj, param1KeyEvent); }
    
    public Bundle getExtras() { return MediaControllerCompatApi21.getExtras(this.mControllerObj); }
    
    public long getFlags() { return MediaControllerCompatApi21.getFlags(this.mControllerObj); }
    
    public Object getMediaController() { return this.mControllerObj; }
    ...
    public String getPackageName() { return MediaControllerCompatApi21.getPackageName(this.mControllerObj); }
    ...
    public List<MediaSessionCompat.QueueItem> getQueue() {
      List list = MediaControllerCompatApi21.getQueue(this.mControllerObj);
      return (list != null) ? MediaSessionCompat.QueueItem.fromQueueItemList(list) : null;
    }
    
    public CharSequence getQueueTitle() { return MediaControllerCompatApi21.getQueueTitle(this.mControllerObj); }
    ...
    public PendingIntent getSessionActivity() { return MediaControllerCompatApi21.getSessionActivity(this.mControllerObj); }
    ...
    public boolean isSessionReady() { return (this.mExtraBinder != null); }
    ...
    public final void registerCallback(MediaControllerCompat.Callback param1Callback, Handler param1Handler) {
      ...
      if (this.mExtraBinder != null) {
        ...
        try {
          this.mExtraBinder.registerCallbackListener(extraCallback);
          return;
        } catch (RemoteException param1Callback) {
          Log.e("MediaControllerCompat", "Dead object in registerCallback.", param1Callback);
          return;
        } 
      } 
      synchronized (this.mPendingCallbacks) {
        param1Callback.mHasExtraCallback = false;
        this.mPendingCallbacks.add(param1Callback);
        return;
      } 
    }
    ...
    public void sendCommand(String param1String, Bundle param1Bundle, ResultReceiver param1ResultReceiver) { MediaControllerCompatApi21.sendCommand(this.mControllerObj, param1String, param1Bundle, param1ResultReceiver); }
    
    public void setVolumeTo(int param1Int1, int param1Int2) { MediaControllerCompatApi21.setVolumeTo(this.mControllerObj, param1Int1, param1Int2); }
    ...
    public final void unregisterCallback(MediaControllerCompat.Callback param1Callback) {
      ...
      if (this.mExtraBinder != null) {
        try {
          ExtraCallback extraCallback = (ExtraCallback)this.mCallbackMap.remove(param1Callback);
          ...
          Log.e("MediaControllerCompat", "Dead object in unregisterCallback.", param1Callback);
          return;
        } 
      } else {
        synchronized (this.mPendingCallbacks) {
          this.mPendingCallbacks.remove(param1Callback);
          return;
        } 
      } 
    }
    ...
    private static class ExtraCallback extends MediaControllerCompat.Callback.StubCompat {
      ExtraCallback(MediaControllerCompat.Callback param2Callback) { super(param2Callback); }
      
      public void onExtrasChanged(Bundle param2Bundle) { throw new AssertionError(); }
      
      public void onMetadataChanged(MediaMetadataCompat param2MediaMetadataCompat) { throw new AssertionError(); }
      
      public void onQueueChanged(List<MediaSessionCompat.QueueItem> param2List) { throw new AssertionError(); }
      
      public void onQueueTitleChanged(CharSequence param2CharSequence) { throw new AssertionError(); }
      
      public void onSessionDestroyed() { throw new AssertionError(); }
      
      public void onVolumeInfoChanged(ParcelableVolumeInfo param2ParcelableVolumeInfo) throws RemoteException { throw new AssertionError(); }
    }
  }
  ...
  private static class ExtraCallback extends Callback.StubCompat {
    ExtraCallback(MediaControllerCompat.Callback param1Callback) { super(param1Callback); }
    
    public void onExtrasChanged(Bundle param1Bundle) { throw new AssertionError(); }
    
    public void onMetadataChanged(MediaMetadataCompat param1MediaMetadataCompat) { throw new AssertionError(); }
    
    public void onQueueChanged(List<MediaSessionCompat.QueueItem> param1List) { throw new AssertionError(); }
    
    public void onQueueTitleChanged(CharSequence param1CharSequence) { throw new AssertionError(); }
    
    public void onSessionDestroyed() { throw new AssertionError(); }
    
    public void onVolumeInfoChanged(ParcelableVolumeInfo param1ParcelableVolumeInfo) throws RemoteException { throw new AssertionError(); }
  }
  
  @RequiresApi(23)
  static class MediaControllerImplApi23 extends MediaControllerImplApi21 {
    public MediaControllerImplApi23(Context param1Context, MediaSessionCompat.Token param1Token) throws RemoteException { super(param1Context, param1Token); }
    
    public MediaControllerImplApi23(Context param1Context, MediaSessionCompat param1MediaSessionCompat) { super(param1Context, param1MediaSessionCompat); }
  ...
  static class MediaControllerImplApi24 extends MediaControllerImplApi23 {
    public MediaControllerImplApi24(Context param1Context, MediaSessionCompat.Token param1Token) throws RemoteException { super(param1Context, param1Token); }
    
    public MediaControllerImplApi24(Context param1Context, MediaSessionCompat param1MediaSessionCompat) { super(param1Context, param1MediaSessionCompat); }
  ...
  static class MediaControllerImplBase implements MediaControllerImpl {
    ...
    public MediaControllerImplBase(MediaSessionCompat.Token param1Token) { this.mBinder = IMediaSession.Stub.asInterface((IBinder)param1Token.getToken()); }
    ...
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      try {
        ...
        return;
      } catch (RemoteException param1MediaDescriptionCompat) {
        Log.e("MediaControllerCompat", "Dead object in addQueueItem.", param1MediaDescriptionCompat);
        return;
      } 
    }
    ...
    public void addQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat, int param1Int) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in addQueueItemAt.", param1MediaDescriptionCompat);
        return;
      } 
    }
    ...
    public boolean dispatchMediaButtonEvent(KeyEvent param1KeyEvent) {
      ...
      } catch (RemoteException param1KeyEvent) {
        Log.e("MediaControllerCompat", "Dead object in dispatchMediaButtonEvent.", param1KeyEvent);
      } 
      return false;
    }
    ...
    public boolean isSessionReady() { return true; }
    ...
    public void registerCallback(MediaControllerCompat.Callback param1Callback, Handler param1Handler) {
      ...
      try {
        ...
        return;
      } catch (RemoteException param1Handler) {
        Log.e("MediaControllerCompat", "Dead object in registerCallback.", param1Handler);
    ...
    public void removeQueueItem(MediaDescriptionCompat param1MediaDescriptionCompat) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in removeQueueItem.", param1MediaDescriptionCompat);
        return;
      } 
    }
    ...
    public void sendCommand(String param1String, Bundle param1Bundle, ResultReceiver param1ResultReceiver) {
      try {
        ...
        return;
      } catch (RemoteException param1String) {
        Log.e("MediaControllerCompat", "Dead object in sendCommand.", param1String);
        return;
      } 
    }
  ...
  public static final class PlaybackInfo {
    ...
    public int getAudioStream() { return this.mAudioStream; }
    
    public int getCurrentVolume() { return this.mCurrentVolume; }
    
    public int getMaxVolume() { return this.mMaxVolume; }
    
    public int getPlaybackType() { return this.mPlaybackType; }
  ...
  static class TransportControlsApi21 extends TransportControls {
    ...
    public TransportControlsApi21(Object param1Object) { this.mControlsObj = param1Object; }
    
    public void fastForward() { MediaControllerCompatApi21.TransportControls.fastForward(this.mControlsObj); }
    
    public void pause() { MediaControllerCompatApi21.TransportControls.pause(this.mControlsObj); }
    
    public void play() { MediaControllerCompatApi21.TransportControls.play(this.mControlsObj); }
    
    public void playFromMediaId(String param1String, Bundle param1Bundle) { MediaControllerCompatApi21.TransportControls.playFromMediaId(this.mControlsObj, param1String, param1Bundle); }
    
    public void playFromSearch(String param1String, Bundle param1Bundle) { MediaControllerCompatApi21.TransportControls.playFromSearch(this.mControlsObj, param1String, param1Bundle); }
    
    public void playFromUri(Uri param1Uri, Bundle param1Bundle) {
      if (param1Uri == null || Uri.EMPTY.equals(param1Uri))
        throw new IllegalArgumentException("You must specify a non-empty Uri for playFromUri."); 
      Bundle bundle = new Bundle();
      bundle.putParcelable("android.support.v4.media.session.action.ARGUMENT_URI", param1Uri);
      bundle.putParcelable("android.support.v4.media.session.action.ARGUMENT_EXTRAS", param1Bundle);
      sendCustomAction("android.support.v4.media.session.action.PLAY_FROM_URI", bundle);
    }
    
    public void prepare() { sendCustomAction("android.support.v4.media.session.action.PREPARE", null); }
    ...
    public void rewind() { MediaControllerCompatApi21.TransportControls.rewind(this.mControlsObj); }
    
    public void seekTo(long param1Long) { MediaControllerCompatApi21.TransportControls.seekTo(this.mControlsObj, param1Long); }
    ...
    public void setRating(RatingCompat param1RatingCompat, Bundle param1Bundle) {
      Bundle bundle = new Bundle();
      bundle.putParcelable("android.support.v4.media.session.action.ARGUMENT_RATING", param1RatingCompat);
      bundle.putParcelable("android.support.v4.media.session.action.ARGUMENT_EXTRAS", param1Bundle);
    ...
    public void skipToNext() { MediaControllerCompatApi21.TransportControls.skipToNext(this.mControlsObj); }
    
    public void skipToPrevious() { MediaControllerCompatApi21.TransportControls.skipToPrevious(this.mControlsObj); }
    
    public void skipToQueueItem(long param1Long) { MediaControllerCompatApi21.TransportControls.skipToQueueItem(this.mControlsObj, param1Long); }
    
    public void stop() { MediaControllerCompatApi21.TransportControls.stop(this.mControlsObj); }
  }
  
  @RequiresApi(23)
  static class TransportControlsApi23 extends TransportControlsApi21 {
    public TransportControlsApi23(Object param1Object) { super(param1Object); }
    
    public void playFromUri(Uri param1Uri, Bundle param1Bundle) { MediaControllerCompatApi23.TransportControls.playFromUri(this.mControlsObj, param1Uri, param1Bundle); }
  }
  
  @RequiresApi(24)
  static class TransportControlsApi24 extends TransportControlsApi23 {
    public TransportControlsApi24(Object param1Object) { super(param1Object); }
    
    public void prepare() { MediaControllerCompatApi24.TransportControls.prepare(this.mControlsObj); }
    
    public void prepareFromMediaId(String param1String, Bundle param1Bundle) { MediaControllerCompatApi24.TransportControls.prepareFromMediaId(this.mControlsObj, param1String, param1Bundle); }
    
    public void prepareFromSearch(String param1String, Bundle param1Bundle) { MediaControllerCompatApi24.TransportControls.prepareFromSearch(this.mControlsObj, param1String, param1Bundle); }
    
    public void prepareFromUri(Uri param1Uri, Bundle param1Bundle) { MediaControllerCompatApi24.TransportControls.prepareFromUri(this.mControlsObj, param1Uri, param1Bundle); }
  }
  
  static class TransportControlsBase extends TransportControls {
    private IMediaSession mBinder;
    
    public TransportControlsBase(IMediaSession param1IMediaSession) { this.mBinder = param1IMediaSession; }
    ...
    public void playFromMediaId(String param1String, Bundle param1Bundle) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in playFromMediaId.", param1String);
        return;
      } 
    }
    ...
    public void playFromSearch(String param1String, Bundle param1Bundle) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in playFromSearch.", param1String);
        return;
      } 
    }
    ...
    public void playFromUri(Uri param1Uri, Bundle param1Bundle) {
      try {
        ...
        return;
      } catch (RemoteException param1Uri) {
        Log.e("MediaControllerCompat", "Dead object in playFromUri.", param1Uri);
        return;
      } 
    }
    ...
    public void prepareFromMediaId(String param1String, Bundle param1Bundle) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in prepareFromMediaId.", param1String);
        return;
      } 
    }
    ...
    public void prepareFromSearch(String param1String, Bundle param1Bundle) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in prepareFromSearch.", param1String);
        return;
      } 
    }
    ...
    public void prepareFromUri(Uri param1Uri, Bundle param1Bundle) {
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in prepareFromUri.", param1Uri);
        return;
      } 
    }
    ...
    public void sendCustomAction(PlaybackStateCompat.CustomAction param1CustomAction, Bundle param1Bundle) { sendCustomAction(param1CustomAction.getAction(), param1Bundle); }
    ...
    public void sendCustomAction(String param1String, Bundle param1Bundle) {
      ...
      try {
        ...
        Log.e("MediaControllerCompat", "Dead object in sendCustomAction.", param1String);
        return;
      } 
    }
    ...
    public void setRating(RatingCompat param1RatingCompat) {
      try {
        ...
        return;
      } catch (RemoteException param1RatingCompat) {
        Log.e("MediaControllerCompat", "Dead object in setRating.", param1RatingCompat);
        return;
      } 
    }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/session/MediaControllerCompat.class
