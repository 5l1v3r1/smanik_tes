...
public class ParcelableVolumeInfo implements Parcelable {
  public static final Parcelable.Creator<ParcelableVolumeInfo> CREATOR = new Parcelable.Creator<ParcelableVolumeInfo>() {
      public ParcelableVolumeInfo createFromParcel(Parcel param1Parcel) { return new ParcelableVolumeInfo(param1Parcel); }
      
      public ParcelableVolumeInfo[] newArray(int param1Int) { return new ParcelableVolumeInfo[param1Int]; }
    };
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/session/ParcelableVolumeInfo.class
