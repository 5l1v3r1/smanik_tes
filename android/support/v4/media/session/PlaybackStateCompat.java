...
public final class PlaybackStateCompat implements Parcelable {
  ...
  public static final Parcelable.Creator<PlaybackStateCompat> CREATOR = new Parcelable.Creator<PlaybackStateCompat>() {
      public PlaybackStateCompat createFromParcel(Parcel param1Parcel) { return new PlaybackStateCompat(param1Parcel); }
      
      public PlaybackStateCompat[] newArray(int param1Int) { return new PlaybackStateCompat[param1Int]; }
    };
  ...
  public static PlaybackStateCompat fromPlaybackState(Object paramObject) {
    ...
    if (paramObject != null && Build.VERSION.SDK_INT >= 21) {
      List list1;
      List list2 = PlaybackStateCompatApi21.getCustomActions(paramObject);
      if (list2 != null) {
      ...
      PlaybackStateCompat playbackStateCompat = new PlaybackStateCompat(PlaybackStateCompatApi21.getState(paramObject), PlaybackStateCompatApi21.getPosition(paramObject), PlaybackStateCompatApi21.getBufferedPosition(paramObject), PlaybackStateCompatApi21.getPlaybackSpeed(paramObject), PlaybackStateCompatApi21.getActions(paramObject), 0, PlaybackStateCompatApi21.getErrorMessage(paramObject), PlaybackStateCompatApi21.getLastPositionUpdateTime(paramObject), list1, PlaybackStateCompatApi21.getActiveQueueItemId(paramObject), bundle);
  ...
  public Object getPlaybackState() {
    if (this.mStateObj == null && Build.VERSION.SDK_INT >= 21) {
      ...
      if (this.mCustomActions != null) {
        ArrayList arrayList1 = new ArrayList(this.mCustomActions.size());
  ...
  public static final class Builder {
    ...
    public Builder addCustomAction(String param1String1, String param1String2, int param1Int) { return addCustomAction(new PlaybackStateCompat.CustomAction(param1String1, param1String2, param1Int, null)); }
    
    public PlaybackStateCompat build() { return new PlaybackStateCompat(this.mState, this.mPosition, this.mBufferedPosition, this.mRate, this.mActions, this.mErrorCode, this.mErrorMessage, this.mUpdateTime, this.mCustomActions, this.mActiveItemId, this.mExtras); }
    ...
    public Builder setState(int param1Int, long param1Long, float param1Float) { return setState(param1Int, param1Long, param1Float, SystemClock.elapsedRealtime()); }
  ...
  public static final class CustomAction implements Parcelable {
    public static final Parcelable.Creator<CustomAction> CREATOR = new Parcelable.Creator<CustomAction>() {
        public PlaybackStateCompat.CustomAction createFromParcel(Parcel param2Parcel) { return new PlaybackStateCompat.CustomAction(param2Parcel); }
        
        public PlaybackStateCompat.CustomAction[] newArray(int param2Int) { return new PlaybackStateCompat.CustomAction[param2Int]; }
      };
    ...
    public static final class Builder {
      ...
      public PlaybackStateCompat.CustomAction build() { return new PlaybackStateCompat.CustomAction(this.mAction, this.mName, this.mIcon, this.mExtras); }
  ...
  static final class null extends Object implements Parcelable.Creator<CustomAction> {
    public PlaybackStateCompat.CustomAction createFromParcel(Parcel param1Parcel) { return new PlaybackStateCompat.CustomAction(param1Parcel); }
    
    public PlaybackStateCompat.CustomAction[] newArray(int param1Int) { return new PlaybackStateCompat.CustomAction[param1Int]; }
  }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/media/session/PlaybackStateCompat.class
