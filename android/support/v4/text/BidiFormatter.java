...
public final class BidiFormatter {
  ...
  private static boolean isRtlLocale(Locale paramLocale) { return (TextUtilsCompat.getLayoutDirectionFromLocale(paramLocale) == 1); }
  ...
  public static final class Builder {
    ...
    private static BidiFormatter getDefaultInstanceFromContext(boolean param1Boolean) { return param1Boolean ? DEFAULT_RTL_INSTANCE : DEFAULT_LTR_INSTANCE; }
    ...
    public BidiFormatter build() { return (this.mFlags == 2 && this.mTextDirectionHeuristicCompat == DEFAULT_TEXT_DIRECTION_HEURISTIC) ? getDefaultInstanceFromContext(this.mIsRtlContext) : new BidiFormatter(this.mIsRtlContext, this.mFlags, this.mTextDirectionHeuristicCompat, null); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/text/BidiFormatter.class
