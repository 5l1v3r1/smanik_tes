...
public abstract class AutoScrollHelper implements View.OnTouchListener {
  ...
  private static class ClampedScroller {
    ...
    private float interpolateValue(float param1Float) { return -4.0F * param1Float * param1Float + param1Float * 4.0F; }
    ...
    public int getHorizontalDirection() { return (int)(this.mTargetVelocityX / Math.abs(this.mTargetVelocityX)); }
    
    public int getVerticalDirection() { return (int)(this.mTargetVelocityY / Math.abs(this.mTargetVelocityY)); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/widget/AutoScrollHelper.class
