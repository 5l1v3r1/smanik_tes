...
public class SwipeRefreshLayout extends ViewGroup implements NestedScrollingParent, NestedScrollingChild {
  ...
  private Animation startAlphaAnimation(final int startingAlpha, final int endingAlpha) {
    Animation animation = new Animation() {
        public void applyTransformation(float param1Float, Transformation param1Transformation) { SwipeRefreshLayout.this.mProgress.setAlpha((int)(startingAlpha + (endingAlpha - startingAlpha) * param1Float)); }
      };
  ...
  public boolean canChildScrollUp() { return (this.mChildScrollUpCallback != null) ? this.mChildScrollUpCallback.canChildScrollUp(this, this.mTarget) : ((this.mTarget instanceof ListView) ? ListViewCompat.canScrollList((ListView)this.mTarget, -1) : this.mTarget.canScrollVertically(-1)); }
  ...
  protected int getChildDrawingOrder(int paramInt1, int paramInt2) { return (this.mCircleViewIndex < 0) ? paramInt2 : ((paramInt2 == paramInt1 - 1) ? this.mCircleViewIndex : ((paramInt2 >= this.mCircleViewIndex) ? (paramInt2 + 1) : paramInt2)); }
  ...
  void moveToStart(float paramFloat) { setTargetOffsetTopAndBottom(this.mFrom + (int)((this.mOriginalOffsetTop - this.mFrom) * paramFloat) - this.mCircleView.getTop()); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/widget/SwipeRefreshLayout.class
