...
public class ViewDragHelper {
  ...
  public void captureChildView(@NonNull View paramView, int paramInt) {
    ...
    this.mCapturedView = stringBuilder;
    this.mActivePointerId = paramInt;
    this.mCallback.onViewCaptured(stringBuilder, paramInt);
    setDragState(1);
  }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v4/widget/ViewDragHelper.class
