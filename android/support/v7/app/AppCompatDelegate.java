...
public abstract class AppCompatDelegate {
  ...
  public static AppCompatDelegate create(Activity paramActivity, AppCompatCallback paramAppCompatCallback) { return create(paramActivity, paramActivity.getWindow(), paramAppCompatCallback); }
  
  public static AppCompatDelegate create(Dialog paramDialog, AppCompatCallback paramAppCompatCallback) { return create(paramDialog.getContext(), paramDialog.getWindow(), paramAppCompatCallback); }
  
  private static AppCompatDelegate create(Context paramContext, Window paramWindow, AppCompatCallback paramAppCompatCallback) { return (Build.VERSION.SDK_INT >= 24) ? new AppCompatDelegateImplN(paramContext, paramWindow, paramAppCompatCallback) : ((Build.VERSION.SDK_INT >= 23) ? new AppCompatDelegateImplV23(paramContext, paramWindow, paramAppCompatCallback) : new AppCompatDelegateImplV14(paramContext, paramWindow, paramAppCompatCallback)); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/app/AppCompatDelegate.class
