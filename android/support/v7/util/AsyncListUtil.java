...
public class AsyncListUtil<T> extends Object {
  ...
  private final ThreadUtil.BackgroundCallback<T> mBackgroundCallback = new ThreadUtil.BackgroundCallback<T>() {
      ...
      private int getTileStart(int param1Int) { return param1Int - param1Int % AsyncListUtil.this.mTileSize; }
      
      private boolean isTileLoaded(int param1Int) { return this.mLoadedTiles.get(param1Int); }
  ...
  private final ThreadUtil.MainThreadCallback<T> mMainThreadCallback = new ThreadUtil.MainThreadCallback<T>() {
      private boolean isRequestedGeneration(int param1Int) { return (param1Int == AsyncListUtil.this.mRequestedGeneration); }
      ...
      public void addTile(int param1Int, TileList.Tile<T> param1Tile) {
        ...
        TileList.Tile tile = AsyncListUtil.this.mTileList.addOrReplace(param1Tile);
        if (tile != null) {
          StringBuilder stringBuilder = new StringBuilder();
      ...
      public void removeTile(int param1Int1, int param1Int2) {
        if (!isRequestedGeneration(param1Int1))
          return; 
        StringBuilder stringBuilder = AsyncListUtil.this.mTileList.removeAtPos(param1Int2);
        ...
        AsyncListUtil.this.mBackgroundProxy.recycleTile(stringBuilder);
      }
  ...
  public static abstract class DataCallback<T> extends Object {
    @WorkerThread
    public abstract void fillData(T[] param1ArrayOfT, int param1Int1, int param1Int2);
    
    @WorkerThread
    public int getMaxCachedTiles() { return 10; }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/util/AsyncListUtil.class
