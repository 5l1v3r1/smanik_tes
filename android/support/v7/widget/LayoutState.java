...
class LayoutState {
  ...
  boolean hasMore(RecyclerView.State paramState) { return (this.mCurrentPosition >= 0 && this.mCurrentPosition < paramState.getItemCount()); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/widget/LayoutState.class
