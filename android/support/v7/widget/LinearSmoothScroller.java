...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
  ...
  public LinearSmoothScroller(Context paramContext) { this.MILLISECONDS_PER_PX = calculateSpeedPerPixel(paramContext.getResources().getDisplayMetrics()); }
  ...
  protected float calculateSpeedPerPixel(DisplayMetrics paramDisplayMetrics) { return 25.0F / paramDisplayMetrics.densityDpi; }
  
  protected int calculateTimeForDeceleration(int paramInt) { return (int)Math.ceil(calculateTimeForScrolling(paramInt) / 0.3356D); }
  
  protected int calculateTimeForScrolling(int paramInt) { return (int)Math.ceil((Math.abs(paramInt) * this.MILLISECONDS_PER_PX)); }
  ...
  protected int getHorizontalSnapPreference() { return (this.mTargetVector == null || this.mTargetVector.x == 0.0F) ? 0 : ((this.mTargetVector.x > 0.0F) ? 1 : -1); }
  
  protected int getVerticalSnapPreference() { return (this.mTargetVector == null || this.mTargetVector.y == 0.0F) ? 0 : ((this.mTargetVector.y > 0.0F) ? 1 : -1); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/widget/LinearSmoothScroller.class
