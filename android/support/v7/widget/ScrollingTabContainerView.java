...
public class ScrollingTabContainerView extends HorizontalScrollView implements AdapterView.OnItemSelectedListener {
  ...
  private boolean isCollapsed() { return (this.mTabSpinner != null && this.mTabSpinner.getParent() == this); }
  ...
  public void animateToVisibility(int paramInt) {
    ...
    if (paramInt == 0) {
      ...
      viewPropertyAnimator1.setListener(this.mVisAnimListener.withFinalVisibility(viewPropertyAnimator1, paramInt));
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/widget/ScrollingTabContainerView.class
