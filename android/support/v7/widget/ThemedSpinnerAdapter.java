...
public interface ThemedSpinnerAdapter extends SpinnerAdapter {
  ...
  public static final class Helper {
    ...
    @NonNull
    public LayoutInflater getDropDownViewInflater() { return (this.mDropDownInflater != null) ? this.mDropDownInflater : this.mInflater; }
    
    @Nullable
    public Resources.Theme getDropDownViewTheme() { return (this.mDropDownInflater == null) ? null : this.mDropDownInflater.getContext().getTheme(); }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/widget/ThemedSpinnerAdapter.class
