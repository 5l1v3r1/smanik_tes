...
class ViewBoundsCheck {
  ...
  View findOneViewWithinBoundFlags(int paramInt1, int paramInt2, int paramInt3, int paramInt4) {
    ...
    for (view = null; paramInt1 != paramInt2; view = view1) {
      ...
      int m = this.mCallback.getChildStart(view2);
      int n = this.mCallback.getChildEnd(view2);
  ...
  static class BoundFlags {
    ...
    void addFlags(int param1Int) { this.mBoundFlags = param1Int | this.mBoundFlags; }
    
    boolean boundsMatch() { return ((this.mBoundFlags & 0x7) != 0 && (this.mBoundFlags & compare(this.mChildStart, this.mRvStart) << 0) == 0) ? false : (((this.mBoundFlags & 0x70) != 0 && (this.mBoundFlags & compare(this.mChildStart, this.mRvEnd) << 4) == 0) ? false : (((this.mBoundFlags & 0x700) != 0 && (this.mBoundFlags & compare(this.mChildEnd, this.mRvStart) << 8) == 0) ? false : (!((this.mBoundFlags & 0x7000) != 0 && (this.mBoundFlags & compare(this.mChildEnd, this.mRvEnd) << 12) == 0)))); }
    
    int compare(int param1Int1, int param1Int2) { return (param1Int1 > param1Int2) ? 1 : ((param1Int1 == param1Int2) ? 2 : 4); }
    
    void resetFlags() { this.mBoundFlags = 0; }
    ...
    void setFlags(int param1Int1, int param1Int2) { this.mBoundFlags = param1Int1 & param1Int2 | this.mBoundFlags & (param1Int2 ^ 0xFFFFFFFF); }
  }
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/android/support/v7/widget/ViewBoundsCheck.class
