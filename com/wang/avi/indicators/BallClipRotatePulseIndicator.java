...
public class BallClipRotatePulseIndicator extends Indicator {
  ...
  public void draw(Canvas paramCanvas, Paint paramPaint) {
    ...
    paramCanvas.scale(this.scaleFloat1, this.scaleFloat1);
    paramPaint.setStyle(Paint.Style.FILL);
    paramCanvas.drawCircle(0.0F, 0.0F, f1 / 2.5F, paramPaint);
    paramCanvas.restore();
    paramCanvas.translate(f1, f2);
    paramCanvas.scale(this.scaleFloat2, this.scaleFloat2);
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/com/wang/avi/indicators/BallClipRotatePulseIndicator.class
