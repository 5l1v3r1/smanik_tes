...
public class BallScaleMultipleIndicator extends Indicator {
  ...
  public void draw(Canvas paramCanvas, Paint paramPaint) {
    for (byte b = 0; b < 3; b++) {
      ...
      paramCanvas.scale(this.scaleFloats[b], this.scaleFloats[b], (getWidth() / 2), (getHeight() / 2));
...
/* Location:              /home/ardzz/smaniktes/SMAN1kTes (1)-dex2jar.jar!/com/wang/avi/indicators/BallScaleMultipleIndicator.class
